    ...
    [
        {
            ...
            "cx_probability": round(hp.uniform("cx_probability_2", 0, 1), 2),
            "cx_alpha": hp.uniform("cx_alpha_2", 0, 1),
            "mut_probability": round(hp.uniform("mut_probability_2", 0, 1), 2),
            "generations": hp.quniform("generations_2", 5, 25, 1),
            "layer_nodes": [
                hp.quniform("layer_1_2", 10, 30, 1),
                hp.quniform("layer_2_2", 10, 30, 1),
            ],
            "mutation_step_size": round(hp.uniform("mutation_step_size_2", 0, 1), 2),
            "mutation_indpb": hp.uniform("mutation_indpb_2", 0, 1),
        },
        {
            "name": "3-layered NN",
            "population_size": hp.quniform("population_size_3", 50, 100, 1),
            "cx_probability": round(hp.uniform("cx_probability_3", 0, 1), 2),
            "cx_alpha": hp.uniform("cx_alpha_3", 0, 1),
            "mut_probability": round(hp.uniform("mut_probability_3", 0, 1), 2),
            ...
            "mutation_step_size": round(hp.uniform("mutation_step_size_3", 0, 1), 2),
            "mutation_indpb": hp.uniform("mutation_indpb_3", 0, 1),
        },
        {
            "name": "4-layered NN",
            "population_size": hp.quniform("population_size_4", 50, 100, 1),
            "cx_probability": round(hp.uniform("cx_probability_4", 0, 1), 2),
            "cx_alpha": hp.uniform("cx_alpha_4", 0, 1),
            "mut_probability": round(hp.uniform("mut_probability_4", 0, 1), 2),
            ...
            "mutation_step_size": round(hp.uniform("mutation_step_size_4", 0, 1), 2),
