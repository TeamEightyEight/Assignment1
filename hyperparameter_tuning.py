...
def test_hyperparameters_vector(args):
    ...
    optimizer = GeneticOptimizer(
        ...
        mut_step_size=round(args["mutation_step_size"], 2),
    ...
    [
        {
            ...
            "tournsize": hp.quniform("tournsize_2", 5, 15, 1),
            "layer_nodes": [
        ...
        },
        {
            ...
            "tournsize": hp.quniform("tournsize_3", 5, 15, 1),
            "layer_nodes": [
        ...
        },
        {
            ...
            "tournsize": hp.quniform("tournsize_4", 5, 15, 1),
            "layer_nodes": [
